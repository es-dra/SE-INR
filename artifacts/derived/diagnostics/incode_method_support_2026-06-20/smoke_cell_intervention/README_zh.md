...
- top example: `urban100/img_001.png` crop `(x=192, y=0, size=64)`
- SC-INR tracking RMSE: `0.09409513`
- LTE tracking RMSE: `0.09501752`
- NoSinc tracking RMSE: `0.10101154`
- selection gate pass rate in candidate pool: `1.000`
...
python scripts/analysis/visualize_cell_intervention.py \
  ...
  --max_candidates 1 \
  --num_select 1 \
  --out artifacts/derived/diagnostics/incode_method_support_2026-06-20/smoke_cell_intervention
```
