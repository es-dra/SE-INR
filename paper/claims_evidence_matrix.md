...
| Final-candidate SC-INR is promising. | Raw key `SC-INR+PhiZ` in `benchmark_signed_phiz.json`; derived summary shows All `+0.0812 dB` vs LTE and `+0.0421 dB` vs SC-INR-NoPhi. | Preliminary. | "The final-candidate SC-INR is a promising seed1 candidate with stronger PSNR." | "SC-INR is the final best model" before multi-seed/aux metrics. |
