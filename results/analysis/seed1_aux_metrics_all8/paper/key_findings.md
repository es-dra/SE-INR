...
中文入口请优先阅读 `README_zh.md`。This file is kept as a short English
machine-readable summary for quick reference; it should not be treated as the
main paper-writing entry point.
